...
freq_table$. <- freq_table$. %>% percent()
freq_table
```
Now, let's complicate things a bit. I suppose we would like to see how these percentages differ for various subpopulations, in our example: men vs women.  
```{r, eval = TRUE, include = TRUE, echo = TRUE}
# First let's save a list of answers to variable, for later use. 
...
# Now let's do few finishing touches: (1) change ugly default name of second column, (2) convert fractions to percents and (3) spread the table to make comparisons easier. 
